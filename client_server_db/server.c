...
int main()
{
    ...
    studentdet[0].name = "Biki Guha";
    studentdet[0].address = "Baruipur,Kolkata";
    studentdet[0].marks1 = 89.0;
    studentdet[0].marks2 = 99.0;

    studentdet[1].roll_no = 2;
    studentdet[1].name = "Prithis Jha";
    studentdet[1].address = "DS Colony,Barackpur";
    studentdet[1].marks1 = 81.0;
    studentdet[1].marks2 = 92.0;

    studentdet[2].roll_no = 3;
    studentdet[2].name = "Nabajit Dey";
    studentdet[2].address = "Fider Road,Shyamnagar";
    studentdet[2].marks1 = 76.0;
    studentdet[2].marks2 = 87.0;

    studentdet[3].roll_no = 4;
    studentdet[3].name = "Dibbedyu Datta";
    studentdet[3].address = "DS Colony,Barackpur";
    studentdet[3].marks1 = 87.0;
    studentdet[3].marks2 = 94.0;

    studentdet[4].roll_no = 5;
    studentdet[4].name = "Dinesh Sekh";
    studentdet[4].address = "Kankinara Bazar,Kankinara";
    studentdet[4].marks1 = 77.0;
    studentdet[4].marks2 = 77.0;

    studentdet[5].roll_no = 6;
    studentdet[5].name = "Somyajit Dhar";
    studentdet[5].address = "1no Thana,Naihati";
    studentdet[5].marks1 = 89.0;
    studentdet[5].marks2 = 91.0;

    studentdet[6].roll_no = 7;
    studentdet[6].name = "Akash Dey";
    studentdet[6].address = "Bhatapara Railway station,Bhatpara";
    studentdet[6].marks1 = 81.0;
    studentdet[6].marks2 = 91.0;

    studentdet[7].roll_no = 8;
    studentdet[7].name = "Pryobrata Ghosh";
    studentdet[7].address = "Saratpally,Shyamnagar";
    studentdet[7].marks1 = 86.0;
    studentdet[7].marks2 = 90.0;

    studentdet[8].roll_no = 9;
    studentdet[8].name = "Anuska Dey";
    studentdet[8].address = "Saratpally,Shyamnagar";
    studentdet[8].marks1 = 90.0;
    studentdet[8].marks2 = 90.0;

    studentdet[9].roll_no = 10;
    studentdet[9].name = "Parichay Sarkar";
    studentdet[9].address = "Fider Road,Shyamnagar";
